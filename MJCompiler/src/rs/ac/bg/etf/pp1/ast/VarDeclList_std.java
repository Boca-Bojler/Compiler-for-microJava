...
public class VarDeclList_std extends VarDeclList {
    ...
    public VarDeclList_std (Final Final, Type Type, VarDecl VarDecl, VarDeclMore VarDeclMore) {
        this.Final=Final;
