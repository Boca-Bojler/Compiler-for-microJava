...
public class FactorContext_meth extends FactorContext {

    private Designator Designator;
    private ActParsList ActParsList;

    public FactorContext_meth (Designator Designator, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorContext_meth(\n");
